...
export default function DimHole(){
    ...
    useEffect(() => {
        axios.get(APIEndpoints.Dimhole, {
                                        ...
                                        return (
                                            <>
                                                <ListItem button onClick={(event) => handleClick(event, item.id + "" + stage.stage)}>
                                                    ...
                                                    {stage.wins ? open.includes(item.id + "" + stage.stage) ? <ExpandLess color="secondary" /> : <ExpandMore color="secondary" /> : null}
                                                </ListItem>
                                                {stage.wins ? (
                                                    <Collapse in={open.includes(item.id + "" + stage.stage)} timeout="auto" unmountOnExit>
                                                    <List component="div" disablePadding>
                                                        <Link to={"/dimhole/" + item.id + "-" + item.path + "/" + stage.stage} className={classes.link}>
