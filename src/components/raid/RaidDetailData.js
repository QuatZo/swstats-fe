...
import RaidDetailTable from './RaidDetailTable';
import RaidDetailFilterForm from './RaidDetailFilterForm';

export default function RaidDetailData(props){
    const initFilters = {
        monsters: [],
        leader: [],
        ratio: [null, null],
                ...
                <Grid container>
                    ...
                    <Grid item md={12} xs={12} lg={12}>
                        <BarChart 
                            ...
                            data={data.chart_data.raid_distribution}
                            indexBy="name"
                            keys={['count']}
                            layout={"vertical"}
                            full
