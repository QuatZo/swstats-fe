...
export default function RiftDetailTable(props){
    ...
    const columns = [
        ...
        { label: 'Average Damage', name: 'avg_dmg', options: { filter: true, sort: true, }, },
        { 
            label: 'Points', 
            name: 'points', 
            options: { 
                filter: true, 
                sort: true,
                hint: "Calculated by given formula: cube_root(SSS) / exp(avg_dmg / highest_dmg)",
            }, 
        },
    ]
